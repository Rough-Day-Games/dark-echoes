...
public class ModMenus {
    ...
    public static final Supplier<MenuType<BaseAugStationMenu>> AUGMENT_STATION_MENU = MENU_TYPE.register("augment_station_menu", () -> IMenuTypeExtension.create(BaseAugStationMenu::new));
}
